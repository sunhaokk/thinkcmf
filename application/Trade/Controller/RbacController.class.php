...
class RbacController extends TradebaseController {
    ...
    public function index() {
        ...
        $data = $this->role_model->where("trade_id = $trade[trade_id]")->order(array("listorder" => "ASC", "id" => "DESC"))->select();
    ...
    public function authorize() {
        $this->auth_access_model = D("Common/OswTradeAuthAccess");
       //角色ID
    ...
    public function authorize_post() {
        ...
        if (IS_POST) {
            ...
            if (is_array($_POST['menuid']) && count($_POST['menuid'])>0) {
                ...
                $menu_model=M("OswTradeMenu");
                $auth_rule_model=M("OswTradeAuthRule");
