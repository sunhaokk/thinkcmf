...
class UserController extends WuliubaseController{
	...
	public function index(){
		...
		$this->assign("page", $page->show('Wuliu'));
	...
	public function delete(){
		...
		if ($this->users_model->delete($id)!==false) {
			M("OswWuliuRoleUser")->where(array("user_id"=>$id))->delete();
			M("OswWuliuUser")->where(array("user_id"=>$id))->delete();
			$this->success("删除成功！");
		} else {
			$this->error("删除失败！");
		}
