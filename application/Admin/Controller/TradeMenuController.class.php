...
class TradeMenuController extends AdminbaseController {
    ...
    public function _initialize() {
        parent::_initialize();
        $this->menu_model = D("Common/OswTradeMenu");
        $this->auth_rule_model = D("Common/OswTradeAuthRule");
    }
    ...
    public function index() {
        ...
        foreach ($result as $n=> $r) {
            ...
            $result[$n]['str_manage'] = '<a href="' . U("TradeMenu/add", array("parentid" => $r['id'], "menuid" => I("get.menuid"))) . '">'.L('ADD_SUB_MENU').'</a> | <a href="' . U("TradeMenu/edit", array("id" => $r['id'], "menuid" => I("get.menuid"))) . '">'.L('EDIT').'</a> | <a class="js-ajax-delete" href="' . U("TradeMenu/delete", array("id" => $r['id'], "menuid" => I("get.menuid")) ). '">'.L('DELETE').'</a> ';
